...
function Update () {
    ...
    var tubePosX = GameObject.Find("tube1").transform.position.x;
    GetComponent(Rigidbody2D).velocity = new Vector2(xmovetube1, 0);

    if (gameObject.CompareTag("tube") && tubePosX <= -6.7) {
        GameObject.Find("tube1").transform.position = Vector2(6.7, randomY);
    }
